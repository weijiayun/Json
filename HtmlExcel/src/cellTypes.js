...
import {CustomListEditor} from './editors/customListEditor'
...
Handsontable.CustomListCell = {
  editor: getEditorConstructor('customList'),
  renderer: getRenderer('customList'),
};
...
Handsontable.cellTypes = {
  ...
  customlist:Handsontable.CustomListCell,
};
